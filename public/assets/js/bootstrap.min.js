...
!(function (t, e) {
  ...
  function lt(t) {
    return (
      'undefined' != typeof ShadowRoot && (t instanceof ot(t).ShadowRoot || t instanceof ShadowRoot)
    );
  }
  var ct = {
    name: 'applyStyles',
  ...
  class Oe extends j {
    ...
    _addEventListeners() {
      N.on(this._element, 'click.dismiss.bs.offcanvas', '[data-bs-dismiss="offcanvas"]', () =>
        this.hide()
      ),
  ...
  class Ye extends j {
    ...
    _getConfig(e) {
      if (
        'string' != typeof (e = { ...ze, ...('object' == typeof e && e ? e : {}) }).target &&
        r(e.target)
      ) {
        let { id: i } = e.target;
